...
import tutoring.javastudy.board.evalutator.BoardEvaluator;

public class CustomPermissionEvaluator implements PermissionEvaluator {

    /*
     * Entity => Evaluator 형식으로 저장
     * */
    private Map<Class<BaseEntity>, Class<PermissionEvaluator>> evaluators = Stream.of(
        new Class[][]{
            {Board.class, BoardEvaluator.class},
            // {Board.class, BoardEvaluator.class},
        }
    ...
    public boolean hasPermission(Authentication authentication, Object targetDomainObject,
        ...
        return hasPrivilege(authentication, targetDomainObject,
